                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('extend-contract-user.index') }}">Extend Contract</a></li>
                            <li class="breadcrumb-item active">Detail Extend Contract</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Detail Extend Contract</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
