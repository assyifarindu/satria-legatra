                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                @if ($item->contract_number == '0')
                                                    <a
                                                        href="{{ route('haki-user.detail', Hashids::encode($item->id)) }}">-</a>
                                                @else
                                                    <a
                                                        href="{{ route('haki-user.detail', Hashids::encode($item->id)) }}">{{ $item->contract_number }}</a>
                                                @endif
                                            </td>
                                            <td class="align-middle"><a
                                                    href="{{ route('haki-user.detail', Hashids::encode($item->id)) }}">{{ $item->description }}</a>
                                            </td>
                                            <td class="align-middle">{{ $item->company }}</td>
                                            <td class="align-middle">HAKI</td>
                                            <td class="align-middle">{{ $item->haki_type }}</td>
                                            <td class="align-middle">{{ $item->duty }}</td>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('haki-user.detail', Hashids::encode($item->id)) }}"
