        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Edit Request Feedback/Drafting Document</h4>

                            <form action="{{ route('request-document.update', $data['tracking']->id) }}" method="post"
                                ...
                                @foreach ($data['document'] as $fb)
                                    <div class="border p-3 mb-3 rounded">
                                        @if ($fb->file != '')
                                            <div class="float-end">
                                                <a href="{{ route('request-document.download-upload', $fb->id) }}"><i
                                                ...
                                                <a
                                                    href="{{ route('request-document.destroy-upload', Hashids::encode($fb->id)) }}"><i
    ...
    <div id="add_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('request-document.add-upload') }}" method="POST" enctype="multipart/form-data"
