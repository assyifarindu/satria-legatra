                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('request-document.index') }}">Request HAKI</a>
                                </li>
                                <li class="breadcrumb-item active">Show Request HAKI</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Request HAKI</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="nav nav-pills flex-column navtab-bg nav-pills-tab text-center"
                                        ...
                                        <a class="nav-link @if ($data['tracking']->status == 1 && $data['tracking']->status_license == null) active show @endif py-2"
                                        ...
                                        <a class="nav-link mt-2 py-2 @if ($data['tracking']->status == 1 && $data['tracking']->status_license == 1) active show @endif  @if ($data['tracking']->status == 1 || $data['tracking']->status_license == 0) disabled @endif"
                                ...
                                <div class="col-lg-10">
                                    <div class="tab-content p-3">
                                        <div class="tab-pane fade @if ($data['tracking']->status == 0 || $data['tracking']->status_license == 0) active show @endif"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="border p-3 rounded mb-3 mb-md-0">
                                                            ...
                                                            <p class="mb-2 ps-3 pt-1"><span class="fw-semibold me-2">Created
                                                                    By :</span>
                                        ...
                                        <div class="tab-pane fade @if ($data['tracking']->status == 1 && $data['tracking']->status_license == 1) active show @endif"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="border p-3 rounded mb-3 mb-md-0">
                                                                ...
                                                                <p class="mb-1 ps-3 pt-1"><span
                                                                        class="fw-semibold me-2">Tipe HAKI </span><b>
                                                                        {{ $document->HakiType->name }}</b></p>
                                                                <p class="mb-1 ps-3 pt-1"><span
                                                                        class="fw-semibold me-2">Duties </span><b>
                                                                        {{ $document->Duty->name }}</b></p>
                                                                <p class="mb-1 ps-3 pt-1"><span
                                                                        class="fw-semibold me-2">Launch By </span><b>
                                                                        {{ $document->launch_by }}</b></p>
                                                                ...
                                                                @if ($data['tracking']->status_license == 1 && $data['tracking']->status == 1 && $data['tracking']->is_cancel == 0)
                                                                    <div class="row mt-4">
                                                                        <div class="col-sm-6">
                                                                        </div> <!-- end col -->
                                                                        <div class="col-sm-6">
                                                                ...
                                                                @if ($data['tracking']->status == 3 && $data['tracking']->is_cancel == 0)
                                                                    <div class="row mt-4">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <div class="text-sm-end mt-2 mt-sm-0">
                                                                                <button type="button"
                                                                                    class="btn btn-primary d-inline waves-effect waves-light btn_final"
                                                                                    title="Revisi" tabindex="0"
                                                                                    data-plugin="tippy"
                                                                                    data-tippy-placement="top"
                                                                                    data-bs-toggle="modal"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="border p-3 rounded mb-3 mb-md-0">
                                                                <div class="float-end">
                                                                    <a
                                                                        href="{{ route('haki-user.detail', Hashids::encode($document->base_document_id)) }}"><i
    ...
    <div id="feedback_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('request-document.feedback') }}" method="POST" id="fileUploadForm"
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('request-document.upload-final') }}" method="POST" id="fileUploadFormFinal"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mt-3">
                                <label for="simpleinput" class="form-label">Attachment <span
                                        class="text-danger">*</span></label>
                ...
                $('#fileUploadForm').ajaxForm({
                    ...
                    complete: function(xhr) {
                        window.location.href =
                            "{{ route('request-document.show-haki', Hashids::encode($data['tracking']->id)) }}";
                    }
                });
            });
        });
