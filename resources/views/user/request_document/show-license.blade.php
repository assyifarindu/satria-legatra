                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="nav nav-pills flex-column navtab-bg nav-pills-tab text-center"
                                        ...
                                        <a class="nav-link @if ($data['tracking']->status == 1 && $data['tracking']->status_license == 0) active show @endif py-2"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="border p-3 rounded mb-3 mb-md-0">
                                                                <div class="float-end">
                                                                    <a
                                                                        href="{{ route('license-user.detail', Hashids::encode($document->base_document_id)) }}"><i
                ...
                $('#fileUploadForm').ajaxForm({
                    ...
                    complete: function(xhr) {
                        window.location.href =
                            "{{ route('request-document.show-license', Hashids::encode($data['tracking']->id)) }}";
                    }
                });
            });
        });
