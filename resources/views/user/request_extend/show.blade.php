                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('request-extend.index') }}">Request
                                        Document</a></li>
                                                ...
                                                @if ($data['tracking']->status >= 3)
                                                    ...
                                                    @foreach ($feedback as $fb)
                                                        <div class="border p-3 mb-3 rounded">
                                                            <div class="float-end">
                                                                <a
                                                                    href="{{ route('request-extend.feedback-download', $fb->id) }}"><i
                                                                        class="mdi mdi-file-download-outline text-muted font-20"
                                                                        title="Download" tabindex="0"
                                                                        data-plugin="tippy"
                                                                        data-tippy-placement="top"></i></a>
                                                                                    ...
                                                                                    @else
                                                                                        <button type="button"
                                                                                            ...
                                                                                            data-iddocument="{{ $document->id }}"><i
                                                                                                class="mdi mdi-mail me-1"></i>
                                                                                            Add Negotiation</button>
                                                                                        <a href="{{ route('request-extend.negotiation-approve', Hashids::encode($document->id)) }}"
                                                                                            class="btn btn-success d-inline waves-effect waves-light"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('request-document.add-negotiation', Hashids::encode($data['tracking']->id)) }}"
                    method="POST" id="fileUploadFormNegotiation" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
...
@section('js')
    <script>
                ...
                $('#fileUploadForm').ajaxForm({
                    ...
                    complete: function(xhr) {
                        window.location.href =
                            "{{ route('request-extend.show', Hashids::encode($data['tracking']->id)) }}";
                    }
                });
            });
        });
        ...
        $(function() {
            $(document).ready(function() {
                $('#fileUploadFormNegotiation').ajaxForm({
                    beforeSend: function() {
                        var percentage = '0';
                    },
                    uploadProgress: function(event, position, total, percentComplete) {
