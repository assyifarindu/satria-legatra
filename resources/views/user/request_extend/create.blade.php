        ...
        <div class="container-fluid">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('request-extend.index') }}">Request Extend
                                        Document</a></li>
                                <li class="breadcrumb-item active">Add Request Extend Document</li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Add Request Extend Document</h4>
                            ...
                            <form action="{{ route('request-extend.store') }}" method="post" id="fileUploadForm"
                                ...
                                <div class="row">
                                    <div class="col-lg-10 mt-3">
                                        ...
                                        <select class="form-select js-example-basic-single category" name="type"
                                            id="type">
                                            <option></option>
                                            <option value="1">Contract/Letter</option>
                                ...
                                <div class="row">
                                    <div class="col-lg-10 mt-3">
                                        <label for="example-select" class="form-label">Judul Dokumen</label>
                                        <select class="form-select js-example-basic-single judul" name="title"
                                            id="title" required></select>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-12">
                                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                                Jika anda membutuhkan template untuk diupload pada request document, silakan
                                                download pada halaman dashboard atau akses <a href="#"
                                                    data-bs-toggle="modal" data-bs-target="#template-document">link ini</a>.
                                            </div>
                                        </div>
                                    </div>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#type').on('change', function() {
                ...
                if ($('#type').find(":selected").val() == 1) {
                    $(main_wrapper).append('<div class="row advancedWrapper">' +
                        '<div class="col-lg-10 mt-3">' +
                        ...
                        '</div>' +
                        '<div class="col-lg-1 mt-3">' +
                        '<label for="simpleinput" class="form-label">Action <span class="text-danger">*</span></label>' +
                        '<button class="btn btn-primary form-control" onclick="addWrapper()"><i class="fas fa-plus"></i></button>' +
                        '</div>' +
                        '</div>' +
                        '<div class="row mt-2">' +
                        '<div class="col-lg-12">' +
                        ...
                        '<div class="row">' +
                        '<div class="col-lg-10 mt-3">' +
                        '<label for="simpleinput" class="form-label">Ruang Lingkup (TOP, Delivery Time, Penalty) <span class="text-danger">*</span></label>' +
        ...
        $('#type').on('change', function() {
            var type = $('#type').val();
            $.ajax({
                url: "{{ url('request-extend-get-item') }}",
                type: 'GET',
                data: {
                    category: type,
                },
                success: function(data) {
                    ...
                    $.each(data, function(value, key) {
                        $judul.append($("<option></option>").attr("value", value).text(key));
                    });
                    $judul.select2({});
                }
            });
