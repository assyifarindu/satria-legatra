        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('license-user.index') }}">License</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Current License Document</h4>
                            <br>
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-4">
                                        <h5 class="mt-0">Judul License</h5>
                            ...
                            @if ($data['contract']->worklocation != null)
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            <h5 class="mt-0">Worklocation</h5>
                                            {{ $data['contract']->worklocation }}
                                        </div>
                                    </div>
                                </div>
                            @endif
            ...
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Timeline License</h4>
                            <br>
