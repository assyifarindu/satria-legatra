                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                @if ($item->contract_number == '0')
                                                    <a
                                                        href="{{ route('license-user.detail', Hashids::encode($item->id)) }}">-</a>
                                                @else
                                                    <a
                                                        href="{{ route('license-user.detail', Hashids::encode($item->id)) }}">{{ $item->contract_number }}</a>
                                                @endif
                                            </td>
                                            <td class="align-middle"><a
                                                    href="{{ route('license-user.detail', Hashids::encode($item->id)) }}">{{ $item->description }}</a>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('license-user.detail', Hashids::encode($item->id)) }}"
