                                ...
                                @foreach ($data['license'] as $item)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="{{ route('extend-license-user.show', Hashids::encode($item->id)) }}" class="btn btn-light btn-xs d-inline waves-effect waves-light btn_extend" title="View Detail" tabindex="0" data-plugin="tippy" data-tippy-placement="top"><i class="fas fa-eye"></i></a>
                                            <a href="{{ route('extend-license-user.show-ringkasan',  Hashids::encode($item->id )) }}" class="btn btn-light btn-xs d-inline waves-effect waves-light btn_view" title="Ringkasan" tabindex="0" data-plugin="tippy" data-tippy-placement="top"><i class="fas fa-book"></i></a>
                                        </td>
