        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('contract-user.index') }}">Contract/Letter</a>
                                </li>
                                <li class="breadcrumb-item active">Contract/Letter</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Contract/Letter</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Current Contract/Letter Document</h4>
                            <br>
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-4">
                                        <h5 class="mt-0">Judul Contract/Letter</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-4">
                                        <h5 class="mt-0">Deal Date | Renew Due Date</h5>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-4">
                                        <h5 class="mt-0">Tipe</h5>
                                        <p>{{ getContractType($data['current_contract']->id) }}</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Timeline Contract/Letter</h4>
                            <br>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach ($item->DocumentFinalAttachment as $dfad)
                                                    <a
                                                        href="{{ route('contract-user.download', Hashids::encode($dfad->id)) }}"><i
