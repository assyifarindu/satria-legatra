                                ...
                                <div class="row">
                                    <div class="col-lg-5 mt-3">
                                        ...
                                        <select id="user" class="form-control" name="user" required>
                                            @foreach ($users as $user)
                                                @if ($user->name == $documentNumber->user)
                                    ...
                                    <div class="col-lg-5 mt-3">
                                        ...
                                        <input type="text" class="form-control @error('nrp_user') is-invalid @enderror"
                                            name="nrp_user" id="nrp_user" value="{{ $documentNumber->nrp_user }}" required
                                            autofocus>
                                        @error('nrp_user')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-lg-5 mt-3">
                                        ...
                                        <select id="create_by" class="form-control" name="create_by" required>
                                            <option></option>
                                            @foreach ($users as $user)
                                                @if ($user->name == $documentNumber->create_by)
                                                    <option selected value="{{ $user->name }}"
                                                        data-personal-number="{{ $user->personal_number }}">
                                                        {{ $user->name }}</option>
                                                @else
                                    ...
                                    <div class="col-lg-5 mt-3">
                                        <label for="nrp">NRP</label>
                                        <input type="text" class="form-control @error('nrp') is-invalid @enderror"
                                            name="nrp" id="nrp" value="{{ $documentNumber->nrp }}" required>
                                        @error('nrp')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col">
                                                ...
                                                <div class="mt-1">
                                                    ...
                                                    <a class="text-sm text-info"
                                                        href="{{ asset('storage' . $documentNumber->file) }}"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col">
                                                <div class="form-group">
                                                    ...
                                                    <select id="receipent" class="form-control" name="receipent"
                                                        ...
                                                        <option></option>
                                                        @foreach ($users as $user)
                                                            @if ($user->name == $documentNumber->receipent)
                                                                <option selected value="{{ $user->name }}"
                                                                    data-personal-number="{{ $user->personal_number }}">
                                                                    {{ $user->name }}</option>
                                                            @else
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            // Initialize Select2
            $("#document_type, #sign_by, #company, #department").select2();
