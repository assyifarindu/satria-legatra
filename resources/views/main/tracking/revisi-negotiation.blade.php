                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('tracking-drafting.revisi-negotiation-update') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-lg-10 mt-3">
                                        ...
                                        <select class="form-select js-example-basic-single" name="priority">
                                            ...
                                            <option value="2" @if ($data['document']->priority == 2) selected @endif>
                                                Medium
                                            </option>
                                        ...
                                        <div class="col-lg-10 mt-3">
                                            ...
                                            <select class="form-select js-example-basic-single jenis_surat"
                                                ...
                                                <option value="Surat Keluar"
                                                    @if ($data['document']->letter_type == 'Surat Keluar') selected @endif>Surat Keluar
                                                </option>
