                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('tracking-drafting.store') }}" method="post" id="fileUploadForm"
                                ...
                                @else
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 mt-3">
                                            <label for="example-select" class="form-label">Company <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 mt-3">
                                            <label for="example-select" class="form-label">PIC</label>
                                            <select class="form-control selectize" multiple name="pic[]" required>
            ...
            $(document).ready(function() {
                $('#fileUploadForm').ajaxForm({
                    beforeSend: function(xhr) {
                        ...
                        var pic = $('select[name="pic[]"]').val(); // Ambil nilai PIC
                        var company = $('select[name="company"]').val(); // Ambil nilai Company

                        // Validasi untuk PIC
                        if (!pic || pic.length === 0) {
                            Swal.fire({
                                title: "PIC belum dipilih",
                                text: "Silakan pilih PIC sebelum melanjutkan",
                                icon: "warning",
                        ...
                        // Validasi untuk Company
                        if (!company || company === '') {
                            Swal.fire({
                                title: "Company belum dipilih",
                                text: "Silakan pilih Company sebelum melanjutkan",
                                icon: "warning",
                                confirmButtonColor: "#4a4fea",
                            });
                            xhr.abort();
