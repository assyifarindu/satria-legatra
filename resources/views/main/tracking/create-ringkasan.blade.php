                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('tracking-drafting.document-filing-store') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-lg-10 mt-3">
                                        <label for="simpleinput" class="form-label">Ringkasan <span
                                                class="text-danger">*</span></label>
                                        <textarea name="ringkasan" class="form-control" cols="30" rows="5"></textarea>
                                    </div>
                                </div>
                ...
                $('#fileUploadForm').ajaxForm({
                    ...
                    complete: function(xhr) {
                        window.location.href =
                            "{{ route('tracking.show', Hashids::encode($data['doc']->request_document_id)) }}";
                    }
                });
