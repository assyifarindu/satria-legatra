                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0" style="background-color: #FFFFFF">
                                <li class="breadcrumb-item" style="padding-left: 10px"><a href="{{ route('home') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item active" style="padding-right: 10px">Request Feedback/Drafting
                                    Document</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Feedback/Drafting Document</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Data Feedback/Drafting Document</h4>
                            <br><br>
                            <div class="text-right">
                                <form class="row g-3 mb-3" action="{{ route('tracking.index') }}" method="GET">
                                    <div class="col-xl-2 col-md-3">
                                        <label for="inputState">Status</label>
                                        <select id="inputState" class="form-select" name="filter">
                                            <option value="all" @if ($data['filter'] == 'all') selected @endif>All
                                                Status</option>
                                            <option value="0" @if ($data['filter'] == '0') selected @endif>
                                                Submitted</option>
                                            <option value="1" @if ($data['filter'] == '1') selected @endif>Legal
                                                Drafting
                                            </option>
                                            <option value="2" @if ($data['filter'] == '2') selected @endif>
                                                Send Draft
                                            </option>
                                            <option value="3" @if ($data['filter'] == '3') selected @endif>
                                                Feedback
                                            </option>
                                            <option value="4" @if ($data['filter'] == '4') selected @endif>
                                                Revisi
                                            </option>
                                            <option value="5" @if ($data['filter'] == '5') selected @endif>
                                                Send Rekanan
                                            </option>
                                            <option value="6" @if ($data['filter'] == '6') selected @endif>
                                                Negosiasi
                                            </option>
                                            <option value="7" @if ($data['filter'] == '7') selected @endif>
                                                Filing
                                            </option>
                                            <option value="cancel" @if ($data['filter'] == 'cancel') selected @endif>
                                                Cancel
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <table class="table nowrap scroll-horizontal-datatable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Jenis</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data['tracking'] as $item)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('tracking.show', Hashids::encode($item->id)) }}">
                                            ...
                                            <td class="align-middle" style="white-space: normal; width: 500px">
                                                {{ Str::limit($item->scope, 50, '...') }}</td>
                                            <td class="align-middle">
                                                @if ($item->is_extend == 1)
                                            ...
                                            <td class="align-middle">
                                                ...
                                                @if ($item->status != 7 && $item->is_cancel == 0)
                                                    <a href="#"
