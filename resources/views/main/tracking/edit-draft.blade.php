                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('tracking-drafting.update') }}" method="post" id="fileUploadForm"
                                ...
                                <div class="row">
                                    <div class="col-lg-10 mt-3">
                                        ...
                                        <select class="form-select js-example-basic-single" name="title_sign">
                                            @foreach ($data['title'] as $i)
                                                <option value="{{ $i->id }}"
                                                    @if ($data['document']->title_id == $i->id) selected @endif>{{ $i->code }} -
                                                    {{ $i->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-12 mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" name="category"
                                                        @if ($data['document']->document_type == 'Surat') checked @endif id="surat"
                                                        value="Surat">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" name="category"
                                                        @if ($data['document']->document_type == 'Agg') checked @endif id="agreement"
                                                        value="Agreement">
                                ...
                                <div class="row wrapperSurat">
                                    @if ($data['document']->document_type == 'Surat')
                                        <div class="col-lg-10 mt-3">
                                            ...
                                            <select class="form-select js-example-basic-single jenis_surat"
                                                ...
                                                <option value="Surat Keluar"
                                                    @if ($data['document']->letter_type == 'Surat Keluar') selected @endif>Surat Keluar</option>
                                                <option value="Surat Kuasa"
                                                    @if ($data['document']->letter_type == 'Surat Kuasa') selected @endif>Surat Kuasa</option>
                                            </select>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="row wrapperTujuan">
                                    @if ($data['document']->letter_type == 'Surat Keluar')
                                        <div class="col-lg-10 mt-3">
                                            ...
                                            <select class="form-select js-example-basic-single" name="tujuan_surat">
                                                <option value="Internal" @if ($data['document']->letter_purpose == 'Internal') selected @endif>
                                                    Internal</option>
                                                <option value="Eksternal"
                                                    @if ($data['document']->letter_purpose == 'Eksternal') selected @endif>Eksternal</option>
                                            </select>
                                        </div>
                                    @endif
                                </div>
                                ...
                                {{-- <div class="row">
                                <div class="col-lg-10 mt-3">
                                    <label for="simpleinput" class="form-label">Contract Number <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="contract_number" placeholder="Contract Number" required value="{{ $data['document']->contract_number }}">
                                </div>
                            </div> --}}
                                    ...
                                    <div class="col-lg-8 mt-3">
                                        ...
                                        <select class="form-select js-example-basic-single" name="duration" required>
                                            ...
                                            @foreach ($data['alert'] as $j)
                                                <option value="{{ $j->id }}"
                                                    @if ($data['document']->alert_id == $j->id) selected @endif>Durasi
                                ...
                                <div class="row">
                                    <div class="col-lg-10 mt-3">
                                        ...
                                        <textarea name="issue" id="" class="form-control" cols="30" rows="5" placeholder="Issue">{{ $data['document']->issue }}</textarea>
                                    </div>
                                </div>
                ...
                $('#fileUploadForm').ajaxForm({
                    ...
                    complete: function(xhr) {
                        window.location.href =
                            "{{ route('tracking.show', Hashids::encode($data['document']->request_document_id)) }}";
                    }
                });
            });
        });
