                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                action="{{ route('license.update-document', Hashids::encode($data['document']->base_document_id)) }}"
                                    ...
                                    <div class="col-lg-10 mt-3">
                                        ...
                                        <select class="form-select js-example-basic-single" name="worklocation">
                                            ...
                                            @foreach ($data['worklocation'] as $w)
                                                <option value="{{ $w->id }}"
                                                    @if ($w->id == $data['document']->id_worklocation) selected @endif>{{ $w->worklocation_code }} - {{ $w->worklocation_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
