                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                action="{{ route('license.update', Hashids::encode($data['document']->base_document_id)) }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-10 mt-3">
                                        <label for="example-select" class="form-label">Worklocation</label>
                                        <select class="form-select js-example-basic-single" name="worklocation">
                                            <option></option>
                                            @foreach ($data['worklocation'] as $w)
                                                <option value="{{ $w->id }}"
                                                    @if ($w->id == $data['document']->id_worklocation) selected @endif>
                                                    {{ $w->worklocation_code }} - {{ $w->worklocation_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
