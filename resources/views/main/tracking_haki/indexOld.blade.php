                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Tracking HAKI</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Tracking HAKI</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title">Data Tracking HAKI</h4>
                            <br><br>
                            <div class="text-right">
                                <form class="row g-3 mb-3" action="{{ route('tracking-haki.index') }}" method="GET">
                                    ...
                                    <div class="col-xl-2 col-md-3">
                                        ...
                                        <select id="inputState" class="form-select" name="filter_position">
                                            <option value="all" @if ($data['filter'] == 'all') selected @endif>All
                                                Position</option>
                                            <option value="legal" @if ($data['filter'] == 'legal') selected @endif>On
                                                Legal</option>
                                            <option value="user" @if ($data['filter'] == 'user') selected @endif>On
                                                User</option>
                                        </select>
                                    </div>
                                    <div class="col-xl-2 col-md-3">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data['tracking'] as $item)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a
                                                    href="{{ route('tracking-haki.show', Hashids::encode($item->id)) }}">{{ Str::limit($item->title, 50, '...') }}</a>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('tracking-haki.show', Hashids::encode($item->id)) }}"
