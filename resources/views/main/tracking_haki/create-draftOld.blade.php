                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('tracking-haki-drafting.store') }}" method="post" id="fileUploadForm"
                                        ...
                                        <div class="col-lg-8 mt-3">
                                            ...
                                            <select class="form-select js-example-basic-single" name="type">
                                                ...
                                                @foreach ($data['type'] as $t)
                                                    <option value="{{ $t->id }}"
                                                        @if ($data['base']->haki_type_id == $t->id) selected @endif>
                                                        {{ $t->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-lg-8 mt-3">
                                            ...
                                            <select class="form-select js-example-basic-single" name="duty">
                                                ...
                                                @foreach ($data['duty'] as $d)
                                                    <option value="{{ $d->id }}"
                                                        @if ($data['base']->duty_id == $d->id) selected @endif>
                                                        {{ $d->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                ...
                $('#fileUploadForm').ajaxForm({
                    ...
                    complete: function(xhr) {
                        window.location.href =
                            "{{ route('tracking-haki.show', Hashids::encode($data['request_id'])) }}";
                    }
                });
            });
        });
