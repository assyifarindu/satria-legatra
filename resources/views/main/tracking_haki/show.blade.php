                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('tracking-haki.index') }}">Request HAKI</a>
                                </li>
                                    ...
                                    <div class="tab-content p-3">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row mt-4">
                                                            ...
                                                            @if ($data['tracking']->status == 0 && $data['tracking']->is_cancel == 0)
                                                                <div class="col-sm-6">
                                                                    <div class="text-sm-end mt-2 mt-sm-0">
                                                                        <a href="{{ route('tracking-haki-drafting', Hashids::encode($data['tracking']->id)) }}"
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="border p-3 rounded mb-3 mb-md-0">
                                                                <div class="float-end">
                                                                    @if ($data['tracking']->status == 1)
                                                                        <a
                                                                            href="{{ route('tracking-haki-drafting.edit', Hashids::encode($document->id)) }}"><i
                                                                ...
                                                                @if ($data['tracking']->status == 1 && $data['tracking']->is_cancel == 0)
                                                                    @if ($data['tracking']->status_license == 1)
                                                                        <div class="col-sm-6">
                                                                            <div class="text-sm-end mt-2 mt-sm-0">
                                                                                <form
                                                                                    action="{{ route('tracking-haki-drafting.registration', Hashids::encode($data['tracking']->id)) }}"
                                                                                    method="POST"
                                                                    ...
                                                                    @else
                                                                        <div class="col-sm-6">
                                                                            <div class="text-sm-end mt-2 mt-sm-0">
                                                                                <form
                                                                                    action="{{ route('tracking-haki-drafting.send-draft', Hashids::encode($data['tracking']->id)) }}"
                                                                                    method="POST"
                                                                                    onclick="confirmFunction()"
                                                                                    class="d-inline">
                                                                                    @csrf
                                        ...
                                        <div class="tab-pane fade @if ($data['tracking']->status == 2) active show @endif"
                                            ...
                                            <div>
                                                ...
                                                <p class="sub-header">Berikut adalah data draft document.</p>
                                                ...
                                                @if ($data['tracking']->status >= 2)
                                                            ...
                                                            <div class="row mt-4">
                                                                ...
                                                                @if ($data['tracking']->status == 2 && $data['tracking']->is_cancel == 0)
                                                                    <div class="col-sm-6">
                                                                        <div class="text-sm-end mt-2 mt-sm-0">
                                                                            <form
                                                                                action="{{ route('tracking-haki-drafting.complete', Hashids::encode($data['tracking']->id)) }}"
                                                    ...
                                                    <div class="row">
                                                        <table id=""
                                                            class="table activate-select nowrap w-100 scroll-horizontal-datatable">
                                                            <thead>
                                                                <tr>
                                                                    <th>#</th>
                                                                    <th>Contract Number</th>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row mt-4">
                                                                ...
                                                                @if ($data['tracking']->status == 3 && $data['tracking']->is_cancel == 0)
                                                                    <div class="col-sm-6">
                                                                        <div class="text-sm-end mt-2 mt-sm-0">
                                                                            <a href="{{ route('tracking-haki-drafting.document-filing', Hashids::encode($document->id)) }}"
                                                                                class="btn btn-success d-inline waves-effect waves-light"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="border p-3 rounded mb-3 mb-md-0">
                                                                <div class="float-end">
                                                                    <a
                                                                        href="{{ route('haki.detail', Hashids::encode($document->base_document_id)) }}"><i
    ...
    <div id="feedback_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('tracking-haki-drafting.feedback-draft') }}" method="POST" id="fileUploadForm"
                ...
                $('#fileUploadForm').ajaxForm({
                    ...
                    complete: function(xhr) {
                        window.location.href =
                            "{{ route('tracking-haki.show', Hashids::encode($data['tracking']->id)) }}";
                    }
                });
            });
        });
