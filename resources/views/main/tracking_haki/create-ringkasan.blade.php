                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('tracking-haki-drafting.filing') }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-lg-10 mt-3">
                                        <label for="simpleinput" class="form-label">HAKI Number <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="haki_number"
                                            placeholder="HAKI Number" required>
                                    </div>
                                </div>
                ...
                $('#fileUploadForm').ajaxForm({
                    ...
                    complete: function(xhr) {
                        window.location.href =
                            "{{ route('tracking-haki.show', Hashids::encode($data['doc']->request_document_id)) }}";
                    }
                });
