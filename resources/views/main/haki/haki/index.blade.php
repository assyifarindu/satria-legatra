...
@section('content')
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Base HAKI</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Base HAKI</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="float-end">
                                <a href="{{ route('haki-export-document') }}" class="btn btn-sm btn-warning"><i
                                        class="fas fa-file-excel"></i> Export</a>
                                <a href="{{ route('haki.create') }}" class="btn btn-sm btn-primary"><i
                                        class="fas fa-plus"></i> Add Filing</a>
                            </div>
                            <h4 class="header-title">Data Base HAKI</h4>
                            <br><br>
                            <div class="row">
                                <div class="col-md-4">
                                            ...
                                            @foreach ($data['haki'] as $item)
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><a
                                                            href="{{ route('haki.detail', Hashids::encode($item->id)) }}">{{ Str::limit($item->description, 50, '...') }}</a>
                                                    </td>
                                                    <td class="align-middle">{{ $item->company }}</td>
                                                    <td class="align-middle">HAKI</td>
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="{{ route('haki.edit', Hashids::encode($item->id)) }}"
                                                    ...
                                                    data-company="{{ $item->company }}" data-number="{{ $item->contract_number }}" data-dealdate="{{ $item->contract_date }}" data-picname="{{ $item->pic_name }} | {{ $item->pic_email }}" data-note="{{ $item->description }}" data-file="{{ $item->file }}" data-duration="{{ date('Y-m-d', strtotime($item->contract_date. ' + '.$item->Alert->duration.' days')) }}"><i class="fas fa-eye"></i></a> --}}
                                                        ...
                                                        <a href="{{ route('haki.edit-document', Hashids::encode($item->id)) }}"
                                                            class="btn btn-light btn-xs d-inline waves-effect waves-light"
                                                            title="Edit Document" tabindex="0" data-plugin="tippy"
                                                            data-tippy-placement="top"><i
                                                                class="fas fa-pencil-alt"></i></a>
                                                        <form
                                                            action="{{ route('haki.destroy', Hashids::encode($item->id)) }}"
                                    ...
                                    <table id="" class="table nowrap w-100 scroll-horizontal-datatable">
                                        ...
                                        <tbody>
                                            @php
                                                $no = 1;
                                            @endphp
                                            @foreach ($data['inactive_haki'] as $item)
                                                <tr>
                                                    @php
                                                        $end_contract = $item->end_contract_date;
                                                        $now = date('Y-m-d');
                                                    ...
                                                    <td class="align-middle"><a href="#"
                                                            ...
                                                            title="Views" tabindex="0" data-plugin="tippy"
                                                            data-tippy-placement="top" data-id="{{ $item->id }}"><i
                                                                class="fas fa-eye"></i></a> <span class="d-inline">
                                                            {{ countViewBaseDocument($item->id) }} views</span>
                                                    </td>
                                                    <td class="align-middle">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="standard-modalLabel">Detail HAKI</h4>
    ...
    <div id="extend_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="standard-modalLabel">Extend HAKI</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                    ...
                    <form action="{{ route('license.store') }}" id="fileUploadForm" enctype="multipart/form-data"
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-12 mt-1">
                                <label class="form-label">Extend HAKI Number <span class="text-danger">*</span></label>
