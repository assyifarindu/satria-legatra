        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Detail Document {{ $document->generateNumber->document_number }}</h4>
                </div>
            </div>
        </div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-xs text-secondary mb-0">{{ $document->generateNumber->document_number }}</p>
                                                </td>
