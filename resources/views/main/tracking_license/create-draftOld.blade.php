                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('tracking-license-drafting.store') }}" method="post" id="fileUploadForm"
                                enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{ $data['request_id'] }}" id="">

                                @if ($data['tracking']->is_extend == true)
                                    <input type="hidden" name="worklocation"
                                        value="{{ $data['tracking']->id_worklocation }}">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 mt-3">
                                            ...
                                            <select class="form-select js-example-basic-single" name="priority" required>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 mt-3">
                                            ...
                                            <select class="form-select js-example-basic-single" name="company" required>
                                                <option></option>
                                    ...
                                    <div class="col-lg-8 mt-3">
                                        ...
                                        <select class="form-select js-example-basic-single" name="pic" required>
                                            <option></option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-checl">
                                                <input type="checkbox" style="transform: scale(1.5); margin-left: 10px"
                                                    ...
                                                    @if ($data['base']->is_extend_automatically) checked @endif id="example-checkbox1">
                                    ...
                                    <div class="row @if ($data['base']->is_unlimited_duration) d-none @endif" id="durationWrapper">
                                        <div class="col-lg-8 mt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-10 mt-3">
                                            <label for="simpleinput" class="form-label">Note <span
                                                    class="text-danger">*</span></label>
                                            <textarea name="note" id="" class="form-control" cols="30" rows="5" placeholder="Note"
                                                required></textarea>
                                        </div>
                                    </div>
                                ...
                                @else
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 mt-3">
                                            <label for="simpleinput" class="form-label">Judul Document <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="document_title"
                                                placeholder="Contract document" value="{{ $data['tracking']->title }}"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-10 mt-3">
                                            <label for="simpleinput" class="form-label">Note <span
                                                    class="text-danger">*</span></label>
                                            <textarea name="note" id="" required class="form-control" cols="30" rows="5"
                ...
                $('#fileUploadForm').ajaxForm({
                    ...
                    complete: function(xhr) {
                        window.location.href =
                            "{{ route('tracking-license.show', Hashids::encode($data['request_id'])) }}";
                    }
                });
            });
        });
