        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Alert Contract</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Alert Contract</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Data Alert Contract</h4>
                            <br><br>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    @if ($item->contract_number == '0')
                                                        <a
                                                            href="{{ route('contract.detail', Hashids::encode($item->id)) }}">-</a>
                                                    @else
                                                        <a
                                                ...
                                                <td class="align-middle">{{ $item->document_type }}</td>
