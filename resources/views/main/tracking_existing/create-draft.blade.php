                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('tracking-haki-drafting.store') }}" method="post" id="fileUploadForm"
                                ...
                                @if ($data['tracking']->is_extend == true)
                                        ...
                                        <div class="col-lg-8 mt-3">
                                            ...
                                            <select class="form-select js-example-basic-single" name="pic">
                                                ...
                                                @foreach ($data['pic'] as $i)
                                                    <option value="{{ $i->id }}"
                                                        @if ($data['base']->pic == $i->id) selected @endif>
                                                        {{ $i->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 mt-3">
                                            <label for="example-select" class="form-label">Duration (Duration -
                                                Alert)</label>
                                            <select class="form-select js-example-basic-single" name="duration">
                                                <option></option>
                                                @foreach ($data['alert'] as $j)
                                                    <option value="{{ $j->id }}"
                                                        @if ($data['base']->alert_id == $j->id) selected @endif>Durasi
                                                        {{ $j->duration }} hari, Alert {{ $j->start_alert }} hari
                                                        sebelumnya</option>
                                                @endforeach
                                            </select>
                                        </div>
