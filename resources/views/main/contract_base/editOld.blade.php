                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                action="{{ route('contract.update-document', Hashids::encode($data['document']->base_document_id)) }}"
                                        ...
                                        <div class="col-lg-10 mt-3">
                                            ...
                                            <select class="form-select js-example-basic-single" name="tujuan_surat">
                                                <option value="Internal"
                                                    @if ($data['document']->letter_purpose == 'Internal') selected @endif>Internal</option>
                                ...
                                <div class="row">
                                    <div class="col-lg-10 mt-3">
                                        ...
                                        <input type="text" class="form-control basic-datepicker" name="contract_date"
                                            id="contract_date" placeholder="Contract Date" required
                                ...
                                <div class="row">
                                    <div class="col-lg-10 mt-3">
                                        <label for="simpleinput" class="form-label">Ringkasan <span
                                                class="text-danger">*</span></label>
                                        <textarea name="ringkasan" class="form-control" rows="3" required>{{ $data['document']->ringkasan }}</textarea>
                                    </div>
                                </div>
