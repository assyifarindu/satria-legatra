        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Extend Filing</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Extend Filing</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Extend Filing <i class="fas fa-arrow-right"></i>
                                [{{ $data['document']->contract_number }}] {{ $data['document']->description }}</h4>

                            <form
                                action="{{ route('contract.update', Hashids::encode($data['document']->base_document_id)) }}"
