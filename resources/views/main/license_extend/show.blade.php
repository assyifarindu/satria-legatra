    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('extended-license.index') }}">Extend Licenses</a></li>
                            <li class="breadcrumb-item active">Detail Extend Licenses</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Detail Extend Licenses</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-4">
                                    <h5 class="mt-0">Licenses Number </h5>
        ...
        <div class="row">
            <div class="col-3">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Timeline Extend Licenses</h4>
                        <br>
            ...
            <div class="col-9">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">History Licenses</h4>
                        <br><br>
