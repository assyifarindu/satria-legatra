            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Detail Document Number {{ $document->document_number }}</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="bg-white border-radius-lg h-100">
                                        <a class="text-center" href="{{ asset('storage/' . $document->file) }}"
                                            target="_blank">
                                            <div
                                        ...
                                        <table class="table align-items-center mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="text-xs text-secondary mb-0">{{ $document->user }}</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>
                                                    ...
                                                    <td>
                                                        <p class="text-xs text-secondary mb-0">{{ $document->create_by }}
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>
                                                        <h6 class="mb-0 text-xs">NRP</h6>
                                                    </th>
                                                    <td>
                                                        <p class="text-xs text-secondary mb-0">{{ $document->nrp }}</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="text-xs text-secondary mb-0">
                                                            ...
                                                            ({{ $document->department->short_name }})</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>
