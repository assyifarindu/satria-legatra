<div class="modal fade" id="request-to-revision-flr-modal" tabindex="-1" aria-labelledby="requestToRevisionFlrModalLabel"
    aria-hidden="true">

    <div class="modal-dialog modal-lg">

        <form id="request-to-revision-flr-form" data-id="{{ $requestDocument->id }}" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="requestToRevisionFlrModalLabel">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="confirm-request-revision-flr">
