                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="form-request-document" class="d-flex flex-column gap-2"
                                ...
                                <div class="col-12">
                                    <label for="project_category" class="fw-bold d-block">
                                        Project Category
                                    </label>

                                    <select name="project_category"
                                        class="form-select @error('project_category') is-invalid @enderror">
                                        <option value="">Select Project Category</option>
                                        <option value="1" {{ old('project_category') == '1' ? 'selected' : '' }}>
                                            Project</option>
                                        <option value="0" {{ old('project_category') == '0' ? 'selected' : '' }}>
                                            Non-Project
                                        </option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="file" class="form-control" name="draft_contract" id="draft_contract"
                                        accept=".pdf" @error('draft_contract') is-invalid @enderror
                                ...
                                <div>
                                    ...
                                    <input type="file" class="form-control" name="quotation" id="quotation"
                                        accept=".pdf" @error('quotation') is-invalid @enderror
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            $("select[name='project_category']").select2({
