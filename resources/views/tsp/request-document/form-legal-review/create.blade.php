        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Form Create Legal Review</h4>
                            <br><br>
                            ...
                            <form id="form-request-document" class="d-flex flex-column gap-2"
                                ...
                                <div>
                                    ...
                                    <textarea name="document_objective" id="document_objective" value="{{ old('document_objective') }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="incoterm" id="incoterm" value="{{ old('incoterm') }}"
                                ...
                                <div>
                                    ...
                                    <textarea name="resume" id="resume" value="{{ old('resume') }}"
                                        class="form-control @error('resume') is-invalid @enderror" placeholder="Resume">{{ old('resume') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea name="legal_note" id="legal_note" value="{{ old('legal_note') }}"
                                        class="form-control @error('legal_note') is-invalid @enderror" placeholder="Legal Note">{{ old('legal_note') }}</textarea>
