            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="float-end">
                                <a href="{{ route('notification.read-all') }}" class="btn btn-sm btn-primary"><i
                                        class="fas fa-envelope-open"></i> Mark As Read All</a>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data['notification'] as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $no++ }}</td>
                                                    <td><a
                                                            href="{{ route($item->url, Hashids::encode($item->id_feature)) }}">{{ $item->feature }}</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if ($item->is_clicked == 0)
                                                            <span class="badge bg-soft-warning text-info p-1">No
                                                                Action</span>
                                                        @else
