...
<html xmlns="http://www.w3.org/1999/xhtml"
    style="font-family: 'Arial', Arial, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
...
<body itemscope itemtype="http://schema.org/EmailMessage"
    style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; width: 100% !important; height: 100%; line-height: 1.6em; background-color: #f6f6f6; margin: 0;"
    bgcolor="#f6f6f6">

    <table class="body-wrap"
        style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; background-color: #f6f6f6; margin: 0;"
        bgcolor="#f6f6f6">
        <tr style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
            <td style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0;"
                valign="top"></td>
            <td class="container" width="600"
                style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; display: block !important; max-width: 600px !important; clear: both !important; margin: 0 auto;"
                valign="top">
                <div class="content"
                    style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; max-width: 600px; display: block; margin: 0 auto; padding: 20px;">
                    <table class="main" width="100%" cellpadding="0" cellspacing=" 0"
                        style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; border-radius: 3px; background-color: #fff; margin: 0; border: 1px solid #e9e9e9;"
                        bgcolor="#fff">
                        <tr
                            style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class=""
                                style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 16px; vertical-align: top; color: #fff; font-weight: 500; text-align: center; border-radius: 3px 3px 0 0; background-color: #AF1B3F; margin: 0; padding: 20px;"
                                ...
                                <span style="margin-top: 10px;display: block;">Email Reminder Sent</span>
                            </td>
                        </tr>
                        <tr
                            style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-wrap"
                                style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 20px;"
                                valign="top">
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            <b>REMINDER NEGOTIATION!</b>
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block"
                                            ...
                                            mengenai request dokumen berikut :
                                            <br><br>
                                            <b>{{ $details['title'] }}</b>
                                        </td>
                                    </tr>
                                    <tr
                                        ...
                                        <td class="content-block"
                                            style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            Untuk dapat melihat lebih rinci, silahkan klik tombol dibawah.
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block"
                                            ...
                                            {{-- @if ($details['type'] == 'Contract')
                                                <a href="https://webportal.patria.co.id/satria-legatra/public/tracking/{{ $details['id'] }}"
                                                    class="btn-primary"
                                                    style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #FFF; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background-color: #2717ff; margin: 0; border-color: #2717ff; border-style: solid; border-width: 8px 16px;">
                                                    Lihat lebih rinci
                                                </a>
                                            @elseif ($details['type'] == 'License')
                                                <a href="https://webportal.patria.co.id/satria-legatra/public/tracking-license/{{ $details['id'] }}"
                                                    class="btn-primary"
                                                    style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #FFF; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background-color: #2717ff; margin: 0; border-color: #2717ff; border-style: solid; border-width: 8px 16px;">
                                                    Lihat lebih rinci
                                                </a>
                                            @else
                                                <a href="https://webportal.patria.co.id/satria-legatra/public/tracking-haki/{{ $details['id'] }}"
                                                    class="btn-primary"
                                                    style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #FFF; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background-color: #2717ff; margin: 0; border-color: #2717ff; border-style: solid; border-width: 8px 16px;">
                                                    Lihat lebih rinci
                                                </a>
                                            @endif
                                            <br><br>
                                            <b>Klik tombol berikut jika anda mengakses dari luar area UTPE.</b> --}}
                                            <br>
                                            @if ($details['type'] == 'Contract')
                                                <a href="https://satria-apps.patria.co.id/satria-legatra/public/tracking/{{ $details['id'] }}"
                                                    class="btn-primary"
                                                    style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #FFF; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background-color: #2717ff; margin: 0; border-color: #2717ff; border-style: solid; border-width: 8px 16px;">
                                                    Lihat lebih rinci
                                                </a>
                                            @elseif ($details['type'] == 'License')
                                                <a href="https://satria-apps.patria.co.id/satria-legatra/public/tracking-license/{{ $details['id'] }}"
                                                    class="btn-primary"
                                                    style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #FFF; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background-color: #2717ff; margin: 0; border-color: #2717ff; border-style: solid; border-width: 8px 16px;">
                                                    Lihat lebih rinci
                                                </a>
                                            @else
                                                <a href="https://satria-apps.patria.co.id/satria-legatra/public/tracking-haki/{{ $details['id'] }}"
                                                    class="btn-primary"
                                                    style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #FFF; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background-color: #2717ff; margin: 0; border-color: #2717ff; border-style: solid; border-width: 8px 16px;">
                                                    Lihat lebih rinci
                                                </a>
                    ...
                    <div class="footer"
                        style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; clear: both; color: #999; margin: 0; padding: 20px;">
                        <table width="100%"
                            style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <tr
                                style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                <td class="aligncenter content-block"
                                    style="font-family: 'Arial',Arial,Arial,sans-serif; box-sizing: border-box; font-size: 12px; vertical-align: top; color: #999; text-align: center; margin: 0; padding: 0 0 20px;"
