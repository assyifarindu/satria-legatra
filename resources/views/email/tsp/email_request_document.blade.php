                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            Email Pemberitahuan, ada request document yang harus di tindak lanjut:
                                            <br><br>
                                        </td>
                                    </tr>
                                    <tr
                                        ...
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            Mohon bantuannya untuk melakukan tindak lanjut atas request tersebut.
                                            Untuk dapat melihat lebih rinci request. silahkan klik tombol dibawah.
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            <a href="https://webportal.patria.co.id/satria-legatra/public/tracking"
                                                class="btn-primary"
                                            ...
                                            <br>
                                            <a href="https://satria-apps.patria.co.id/satria-legatra/public/tracking"
                                                class="btn-primary"
