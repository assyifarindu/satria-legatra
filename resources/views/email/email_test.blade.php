                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            Bersama dengan email ini kami ingin memberitahukan bahwa masa berlaku
                                            dokumen berikut:
                                            <br><br>
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            Mohon bantuannya untuk melakukan tindak lanjut atas dokumen tersebut.
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            <a href="https://webportal.patria.co.id/satria-legatra/public/alert-user"
                                                class="btn-primary"
                                            ...
                                            <br>
                                            <a href="https://satria-apps.patria.co.id/satria-legatra/public/alert-user"
                                                class="btn-primary"
