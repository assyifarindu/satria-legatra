                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            <b>Document Extend Automatically!</b>
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            Bersama dengan email ini kami ingin memberitahukan bahwa document berikut
                                            berhasil diperpanjang otomatis oleh Legatra
                                            Detail dokument:
                                            <br><br>
                                            <b>[{{ $details['data']['contract_number'] }}] -
                                                {{ $details['data']['title'] }}</b><br>
                                            Berlaku hingga <b>{{ $details['data']['end_contract'] }}</b>
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                            valign="top">
                                            @if ($details['data']['type'] == '1')
                                                <a href="https://satria-apps.patria.co.id/satria-legatra/public/contract/detail/{{ $details['data']['id'] }}"
                                                    class="btn-primary"
                                            ...
                                            @elseif ($details['data']['type'] == '2')
                                                <a href="https://satria-apps.patria.co.id/satria-legatra/public/license/detail/{{ $details['data']['id'] }}"
                                                    class="btn-primary"
                                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #FFF; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background-color: #2717ff; margin: 0; border-color: #2717ff; border-style: solid; border-width: 8px 16px;">
                                                    Lihat lebih rinci
                                                </a>
                                            @else
                                                <a href="https://satria-apps.patria.co.id/satria-legatra/public/haki/detail{{ $details['data']['id'] }}"
                                                    class="btn-primary"
                                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; color: #FFF; text-decoration: none; line-height: 2em; font-weight: bold; text-align: center; cursor: pointer; display: inline-block; border-radius: 5px; text-transform: capitalize; background-color: #2717ff; margin: 0; border-color: #2717ff; border-style: solid; border-width: 8px 16px;">
                                                    Lihat lebih rinci
                                                </a>
