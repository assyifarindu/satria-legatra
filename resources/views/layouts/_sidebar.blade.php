                    ...
                    <li>
                        ...
                        <div class="collapse" id="requestuser">
                            <ul class="nav-second-level" style="background-color: #FFFFFF">
                                <li>
                                    <a href="{{ route('request-document.index') }}">
                                        <span>Drafting/Feedback Document </span>
                                    </a>
                                </li>
                                <li>
                    ...
                    <li>
                        ...
                        <div class="collapse" id="request">
                            <ul class="nav-second-level" style="background-color: #FFFFFF">
                                @if (PermissionActionMenu('tracking') == true)
                                    <li>
                                        <a href="{{ route('tracking.index') }}">Drafting/Feedback Document
                                            @if (countContract() > 0)
                                                <span
                    ...
                    <li class="mt-2">
                        ...
                        <div class="collapse" id="master">
                            <ul class="nav-second-level" style="background-color: #FFFFFF">
                                ...
                                @endif
                                @if (PermissionActionMenu('master-checklist') == true)
                                    <li>
                                        <a href="{{ route('master-checklist.index') }}">Checklist Document</a>
                                    </li>
                                @endif
                                @if (PermissionActionMenu('log-error-legatra') == true)
                                    <li>
                                        <a href="{{ route('log-error-legatra.index') }}">Log Error</a>
                                    </li>
                                @endif
                            </ul>
                        </div>
