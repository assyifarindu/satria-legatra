            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Master Template</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-body">
                            <div class="float-end">
                                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#add_modal"><i class="fas fa-plus"></i> Add Template</a>
                            </div>
                            <h4 class="header-title">Master Template</h4>
                            <br><br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="standard-modalLabel">Add Template</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('master-template.store') }}" method="POST" enctype="multipart/form-data"
                    id="fileUploadForm">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-3">
                                ...
                                <input type="text" class="form-control" value="{{ $data['company']->name }}" required
                                    readonly>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <form action="{{ route('master-template-update') }}" method="POST" id="fileUploadFormDua"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                @foreach ($data['company'] as $item)
                                    <option value="{{ $item->id }}" @if ($template->company_id == $item->id) selected @endif>{{ $item->name }}</option>
                                @endforeach
                            </select> --}}
                                    <input type="hidden" name="company" value="{{ $data['company']->id }}">
