...
class HakiController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            $data = [
                'haki' => BaseDocument::where('category', 3)->where('is_extend', 0)->where('status', 1)->where('company', $company_name)->orderBy('created_at', 'desc')->get(),
                'inactive_haki' => BaseDocument::where('category', 3)->where('is_extend', 0)->where('status', 0)->where('company', $company_name)->orderBy('deleted_at', 'desc')->get(),
                // 'haki' => Document::where('category', 3)->where('is_extend', 0)->where('status', 1)->orderBy('created_at', 'desc')->get(),
                'duration' => TableAlert::get()
            ];

            return view('main.haki.haki.index')->with('data', $data);
        } catch (Exception $e) {
            $this->ErrorLog($e);
    ...
    public function create()
    {
        try {
            ...
            return view('main.haki.haki.create')->with('data', $data);
        } catch (Exception $e) {
            $this->ErrorLog($e);
            $this->ErrorLogLegatra($e);
            return redirect()->back()->with('error', 'Error Request, Exception Error ');
    ...
    public function show($id)
    {
        try {
            ...
            return view('main.haki.haki.show')->with('data', $data);
        } catch (Exception $e) {
            $this->ErrorLog($e);
            $this->ErrorLogLegatra($e);
            return redirect()->back()->with('error', 'Error Request, Exception Error ');
    ...
    public function edit($id)
    {
        try {
            ...
            return view('main.haki.haki.extend')->with('data', $data);
        } catch (Exception $e) {
            $this->ErrorLog($e);
            // dd($e);
            $this->ErrorLogLegatra($e);
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $base_document->haki_type_id = $request->type;
            $base_document->duty_id = $request->duty;
            $base_document->launch_by = $request->launch_by;
    ...
    public function detail($id)
    {
        try {
            ...
            return view('main.haki.haki.detail')->with('data', $data);
        } catch (Exception $e) {
            $this->ErrorLog($e);
            $this->ErrorLogLegatra($e);
            return redirect()->back()->with('error', 'Error Request, Exception Error ');
    ...
    {
        $id = Hashids::decode($id);
        $document = DocumentFinalAttachment::findOrFail($id['0']);
    ...
    public function editDocument($id)
    {
        try {
            ...
            return view('main.haki.haki.edit')->with('data', $data);
        } catch (Exception $e) {
            $this->ErrorLog($e);
            $this->ErrorLogLegatra($e);
            return redirect()->back()->with('error', 'Error Request, Exception Error ');
    ...
    public function updateDocument(Request $request, $id)
    {
        try {
            ...
            $document->launch_by = $request->launch_by;
    ...
    {
        $date = date('Y-m-d');
        return Excel::download(new ExportHaki, 'HakiFiling_' . $date . '.xlsx');
    }
}
