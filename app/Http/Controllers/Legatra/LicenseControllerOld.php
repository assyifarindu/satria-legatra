    ...
    public function index()
    {
        try {
            $data = [
                ...
                'license' => BaseDocument::where('category', 2)->where('is_extend', 0)->where('status', 1)->orderBy('created_at', 'desc')->get(),
                'inactive_license' => BaseDocument::where('category', 2)->where('is_extend', 0)->where('status', 0)->orderBy('deleted_at', 'desc')->get(),
