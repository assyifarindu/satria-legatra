...
class HakiController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            $data = [
                'haki' => BaseDocument::where('category', 3)->where('is_extend', 0)->where('status', 1)->orderBy('created_at', 'desc')->get(),
                'inactive_haki' => BaseDocument::where('category', 3)->where('is_extend', 0)->where('status', 0)->orderBy('deleted_at', 'desc')->get(),
