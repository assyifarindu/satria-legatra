...
class QRDocumentController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $qrDocuments = QRDocument::join('satria.users', 'user_id', '=', 'satria.users.id')->where('satria.users.company_name', $company_name)
            ->select('qr_documents.*')
            ->get();
    ...
    public function create()
    {
        try {
            ...
            ->where('generate_numbers.company_id', $company->id)
