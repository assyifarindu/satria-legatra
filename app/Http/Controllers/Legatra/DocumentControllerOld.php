    ...
    public function index()
    {
        try {
            ...
            $data = [
                ...
                'contract' => BaseDocument::where('category', 1)->where('is_extend', 0)->where('status', 1)->orderBy('created_at', 'desc')->get(),
                'inactive_contract' => BaseDocument::where('category', 1)->where('is_extend', 0)->where('status', 0)->orderBy('deleted_at', 'desc')->get(),
