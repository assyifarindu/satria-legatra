...
class ExportLicense implements FromView
{
    /**
    ...
    {
        $query = BaseDocument::where('category', 2)->get(['*', 'created_at as pic', 'created_at as document_scope']);
